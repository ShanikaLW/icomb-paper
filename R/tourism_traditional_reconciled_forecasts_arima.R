...
load(here("results-empirical-traditional/tourism_base_forecasts_arima.Rdata"))
...
save(list = ls(all = TRUE), file = here("results-empirical-traditional/tourism_traditional_reconciled_forecasts_arima.Rdata"))
